...
description: Customer Journey AnalyticsのためにフィルターディメンションをReport Builderで使用する方法を説明します
role: User
...
1. 「**一番人気**」または「**特定**」を選択します。
   ...
   ![フィルターディメンションウィンドウで選択した特定のオプション。](./assets/image28.png)
...
![「特定のオプション」と「選択した項目」。](./assets/image32.png)
...
1. 「**リストから**」オプション選択して、ディメンション項目を検索および選択します。
   ...
   ![「元のリスト」オプションおよび使用可能な項目。](./assets/image33.png)
...
1. 過去 90 日間のデータに含まれていない項目を検索するには、「**過去 6 か月間の項目を表示**」をクリックして、検索範囲を広げます。
   ...
   ![「過去 6 ヶ月の項目を表示」リスト。](./assets/image34.png)

   過去 6 か月のデータの読み込み後、Report Builderはリンクを **過去 18 ヶ月間の項目を表示**.
...
1. ディメンション項目を選択します。
   ...
   ![ディメンション項目のリスト。](./assets/image36.png)
...
![「セルの範囲から選択」オプションおよびフィールドを使用して、セルの範囲を 1 つ選択します。](./assets/image37.png)
