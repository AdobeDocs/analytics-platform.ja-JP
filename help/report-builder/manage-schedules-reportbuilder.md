---
title: Report Builderでのスケジュール済みワークブックの管理
description: Report Builderでスケジュール済みワークブックを管理する方法について説明します。
role: User, Admin
...
1. 「**[!UICONTROL ワークブック]**」タブを選択します。 スケジュールされたすべてのワークブックのリストが表示されます。 （または、「**[!UICONTROL レガシー]**」タブを選択して、新しい Report Builder に移行する必要があるレガシーワークブックのリストを表示できます）。
