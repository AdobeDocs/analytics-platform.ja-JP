...
| 名前 | 値 | 上限のタイプ | 説明 |
|---|--:|---|---|
| フィルターごとのコンテナ | 50 | システム強制ガードレール | セグメントあたりの最大コンテナ数。 |
| 計算指標あたりの指標 | 25 | システム強制ガードレール | 計算指標あたりの最大指標の数。 |
| フィルターごとの指標とディメンション | 25 | システム強制ガードレール | セグメントごとの一意の指標とディメンションの最大数。 |
| フィルターごとのネストされたコンテナ | 10 | システム強制ガードレール | セグメントあたりのネストされたコンテナの最大数。 |
