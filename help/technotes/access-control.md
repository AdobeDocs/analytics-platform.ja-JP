...
| [!UICONTROL レポートツール] | [!UICONTROL オーディエンスの作成] | ユーザーが[&#x200B; オーディエンス &#x200B;](/help/components/audiences/audiences-overview.md)を作成できるようにする。 Adobe Experience Platformで[&#x200B; セグメントの管理](https://experienceleague.adobe.com/ja/docs/experience-platform/access-control/home)が必要です。 |
