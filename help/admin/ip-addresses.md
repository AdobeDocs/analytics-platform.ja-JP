---
title: Customer Journey AnalyticsIP許可リストに加える
...
# Customer Journey Analyticsで使用する IP アドレス
...
このページには、アウトバウンドシステムが機能するた許可リストに加えるめに、に追加する必要のある IP アドレスが含まれています。例えば、 [クラウドプロバイダーへのデータのエクスポート](/help/analysis-workspace/export/export-cloud.md).
