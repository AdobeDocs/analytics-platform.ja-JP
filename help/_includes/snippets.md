...
* **13 か月** [!BADGE B2B edition]{type=Informative}
...
* **グローバルアカウント （レポートウィンドウ）** [!BADGE B2B edition]{type=Informative}
* **アカウント （レポートウィンドウ）** [!BADGE B2B edition]{type=Informative}
* **商談（レポートウィンドウ）** [!BADGE B2B edition]{type=Informative}
* **購入グループ （レポートウィンドウ）** [!BADGE B2B edition]{type=Informative}
...
>[!AVAILABILITY]
>
>この記事で説明されている機能、および [!BADGE B2B editionでバッジが付いたその他の記事または機能 ]{type=Informative}<br/> また、[!BADGE B2B edition]{type=Informative}[!BADGE B2B edition]{type=Informative}<br/> 機能が一般入手可能になったら、このメモは削除されます。 Customer Journey Analytics リリースプロセスについて詳しくは、[Customer Journey Analytics機能リリース ](/help/release-notes/releases.md) を参照してください。
>
...
>[!INFO]
>
このドキュメントでは、Customer Journey Analytics B2B editionでのみ使用できる特定の B2B 記事または機能に、[!BADGE B2B editionとマークが付けられています ]{type=Informative}
