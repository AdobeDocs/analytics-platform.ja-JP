...
[![DataDownload](/help/assets/icons/DataDownload.svg) サンプルの概要データをダウンロード](./assets/summary-data.csv)
...
[![DataDownload](/help/assets/icons/DataDownload.svg) サンプルイベントデータをダウンロード](./assets/event-data.csv)
...
[![DataDownload](/help/assets/icons/DataDownload.svg) サンプル検索データをダウンロード](./assets/lookup-data.csv)
+++
...
1. **[!UICONTROL フィールドグループ]**&#x200B;の![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL Add]**&#x200B;を選択します。
...
1. スキーマ名&#x200B;**[!UICONTROL 概要データスキーマの例]**&#x200B;の横にある![AddCircle](/help/assets/icons/AddCircle.svg)を選択します。 **[!UICONTROL フィールドプロパティ]** パネルが開き、フィールドの詳細を追加できます。
