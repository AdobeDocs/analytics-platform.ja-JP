...
* 標準の永続性に類似するパターン（例えば、セッションや人物に値を転送する）の場合は、[次または前](/help/data-views/derived-fields/derived-fields.md#next-or-previous)でパターンをシミュレートする代わりに、ディメンションの[永続性](/help/data-views/component-settings/persistence.md)設定（**[!UICONTROL 配分モデル]**&#x200B;および&#x200B;**[!UICONTROL 有効期限]**）をデータビューで使用します。
...
* ディメンションの[永続性](/help/data-views/component-settings/persistence.md)設定の&#x200B;**[!UICONTROL 配分モデル]**&#x200B;と&#x200B;**[!UICONTROL 有効期限]**&#x200B;を調整して、名前と動作を調整します。 例えば、`Original Source`では、**[!UICONTROL 配分モデル]**&#x200B;を&#x200B;**[!UICONTROL 元]**&#x200B;に設定し、**[!UICONTROL 有効期限]**&#x200B;を&#x200B;**[!UICONTROL 人物]**&#x200B;に設定する必要があります。
