...
[派生フィールド &#x200B;](/help/connections/overview.md)、[&#x200B; セグメント &#x200B;](/help/data-views/data-views.md)、[&#x200B; ワークスペースプロジェクト &#x200B;](/help/analysis-workspace/home.md)の具体的な設定と設定により、一般的なCustomer Journey Analytics設定（[connection](#derived-fields)、[&#x200B; データビュー](#segments)、および[&#x200B; ワークスペースプロジェクト &#x200B;](#workspace-project)）内のLLMとAI生成トラフィックについてレポートできます。
