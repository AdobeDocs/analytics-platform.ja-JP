...
1. 左側の「**[!UICONTROL ビジュアライゼーション]**」タブをクリックし、フロービジュアライゼーションを Workspace キャンバスにドラッグします。
...
1. 左側の「**[!UICONTROL ビジュアライゼーション]**」タブをクリックし、ヒストグラムビジュアライゼーションを Workspace キャンバスにドラッグします。
