...
* CX Enterprise製品を通じてオーディエンスをアクティベーション：
   ...
   * [AJOのユーザーにアプリ内エンゲージメントを配信](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/channels/in-app/get-started-in-app)
* Adobe Real-time CDPで[ オーディエンスを外部宛先にアクティベート ](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/ui/activate/activation-overview)&#x200B;
