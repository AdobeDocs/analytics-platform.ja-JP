---
title: 商品の価値を構築する
description: Customer Journey Analytics B2B editionを利用して、商品価値を構築する方法をご紹介します。
...
1. **[!UICONTROL チャート設定]**&#x200B;を選択します。 例：![GraphBarVerticalStacked](/help/assets/icons/GraphBarVerticalStacked.svg) **[!UICONTROL Stacked bar]**。
1. 優先する![ カレンダー](/help/assets/icons/Calendar.svg) **[!UICONTROL 間隔]**&#x200B;および&#x200B;**[!UICONTROL 日付範囲]**&#x200B;を選択します。

![B2B ユースケース – 製品価値の構築 – 解約の削減 – アクティブな成長](assets/b2b-uc-build-product-value-active-growth.png)
...
1. 関連する指標をアプリキャンバスにドラッグ&amp;ドロップします。 例：**[!UICONTROL グローバルアカウント]**、**[!UICONTROL 商談]**、**[!UICONTROL 契約成立]**、**[!UICONTROL 契約成立]**、**[!UICONTROL 契約成立]**、および&#x200B;**[!UICONTROL 契約成立]**。
   ...
   ![B2B ユースケース – 製品価値の構築 – インサイトの民主化 – モバイルスコアカード ](assets/b2b-uc-build-product-value-mobile-scorecard.png)
...
1. ダッシュボードをプレビューするには、**[!UICONTROL プレビュー]**&#x200B;を使用します。 ダッシュボードは、[Google Play](https://apps.apple.com/us/app/adobe-analytics-dashboards/id1509062264)または[App Store](https://play.google.com/store/apps/details?id=com.adobe.analyticsdashboards)からAdobe Analytics ダッシュボードアプリで利用できるようになりました。
   ...
   ![B2B ユースケース – 製品価値の構築 – インサイトの民主化 – モバイルスコアカードのプレビュー](assets/b2b-uc-build-product-value-mobile-scorecard-preview.png)
