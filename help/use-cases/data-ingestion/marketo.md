...
Customer Journey AnalyticsのMarketo Engage データについてレポートするには：

+++ &#x200B;1. Marketo ソースデータフィールドをXDM ターゲットにマッピングする
...
+++ &#x200B;2. Adobe Experience PlatformへのMarketo データの取り込み
