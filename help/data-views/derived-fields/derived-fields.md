...
>title="Typecast"
>abstract="この関数には、フィールドタイプをその場で変更する機能があり、Customer Journey Analytics内の追加の変換にフィールドを使用できるようになります。"

>[!CONTEXTUALHELP]
>id="dataview_derivedfields_depth"
>title="深さ"
>abstract="この関数には、イベントの深度の標準コンポーネントの機能と同様に、任意のフィールドの深度を返す機能があります。"
