...
詳しくは、 [CJA でのディメンションと指標のバインディングの使用](../../use-cases/binding-dimensions-metrics.md) 連結寸法の効果的な使用方法の例を示します。
...
の 2 つ目の例を参照してください。 [CJA でのディメンションと指標のバインディングの使用](../../use-cases/binding-dimensions-metrics.md) バインディング指標を効果的に使用する方法について詳しくは、を参照してください。
