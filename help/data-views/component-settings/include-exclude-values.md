...
| [!UICONTROL 次に一致] | アトリビューションやセグメントに先立つレポートで考慮する値を指定できます（例：「error」という語句を含む値のみを使用）。 **[!UICONTROL すべての条件を満たしている場合]**&#x200B;または&#x200B;**[!UICONTROL いずれかの条件を満たしている場合]**&#x200B;を指定できます。 それぞれの値をスペースで区切ります。 |
