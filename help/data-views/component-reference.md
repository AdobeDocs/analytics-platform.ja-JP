...
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/ja/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey AnalyticsB2B edition"}<br/>[!UICONTROL &#x200B; アカウント &#x200B;] | 指標 | 「[!UICONTROL &#x200B; 接続 &#x200B;]」で指定されたアカウント ID に基づいています。 |
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/ja/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey AnalyticsB2B edition"}<br/>[!UICONTROL &#x200B; グローバルアカウント &#x200B;] | 指標 | [!UICONTROL &#x200B; 接続 &#x200B;] で指定されたグローバルアカウント ID に基づいています。 |
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/ja/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey AnalyticsB2B edition"}<br/>[!UICONTROL &#x200B; 商談 &#x200B;] | 指標 | 商談。「接続 [!UICONTROL &#x200B; で指定した商談 ID に基づ &#x200B;] ています。 |
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/ja/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey AnalyticsB2B edition"}<br/>[!UICONTROL &#x200B; 購買グループ &#x200B;] | 指標 | [!UICONTROL &#x200B; 接続 &#x200B;] で指定された購入グループ ID に基づく購入グループ。 |
