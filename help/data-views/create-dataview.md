...
新規または既存のデータ・ビューを構成する手順は、次のとおりです。

1. を選択します。 **[!UICONTROL 設定]** 」タブ（まだアクティブでない場合）

   ![データビューの設定](assets/dataview-configure.png)
1. 指定 [!UICONTROL 設定], [!UICONTROL コンテナ]、および [!UICONTROL カレンダー] 詳細（以下を参照）。
1. 選択 **[!UICONTROL 保存して続行]** をクリックして、新しいデータビューまたは既存のデータビューの設定を続行します。 選択 **[!UICONTROL 保存]** 既存のデータビューの設定を保存します。
...
1. を使用してスキーマフィールドを検索します。 ![検索アイコン](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Search_18_N.svg) **[!UICONTROL スキーマフィールドを検索]** または、データセットコレクション ( ![フォルダーアイコン](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Folder_18_N.svg) **[!UICONTROL イベントデータセット]**.<br/>または、 ![データアイコン](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Data_18_N.svg) **派生フィールドを作成** . 詳しくは、 [派生フィールド](./derived-fields/derived-fields.md) を参照してください。

1. 特定のスキーマフィールドまたは派生フィールドを定義したら、そのフィールド ( 例： ![ハンドルアイコン](https://spectrum.adobe.com/static/icons/workflow_22/Smock_DragHandle_22_N.svg) **[!UICONTROL ページ名]**をクリックし、左側のレールから「指標またはDimension」セクションに移動します。
