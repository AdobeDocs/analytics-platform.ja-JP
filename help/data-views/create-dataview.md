...
| [!UICONTROL コンテナ] | ここでコンテナの名前を変更できます。このデータビューに基づく Workspace プロジェクトで、コンテナはこの名前で表示されます。 [!UICONTROL コンテナはフィルターやフォールアウト／フローなどで、範囲やコンテキストの広さや狭さを定義するのに使用されます。 ][詳細情報](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/cja-filters/filters-overview.html?lang=ja#filter-containers) |
