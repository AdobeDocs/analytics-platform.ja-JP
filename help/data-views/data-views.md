...
[!UICONTROL Customer Journey Analytics]でデータビュー](/help/data-views/manage-dataviews.md#delete-data-views)を[削除すると、この削除されたデータビューに依存する[!UICONTROL Workspace] プロジェクトが機能しなくなります。
