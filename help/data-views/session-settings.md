...
1. 「**[!UICONTROL 設定]**」タブを選択します。[!UICONTROL セッション設定]の下：
   ...
   1. データビューをセグメント化する場合は、**[!UICONTROL セグメントを追加]** ドロップダウンメニューからセグメントを選択します。 または、左側のパネルの ![&#x200B; ここにセグメントをドロップ &#x200B;](/help/assets/icons/Segmentation.svg) のセグメント化 **&#x200B;**&#x200B;セグメント **[!UICONTROL _からセグメントをドラッグ&amp;ドロップすることもでき_]** す。

      データビュー用に定義したコンポーネントに基づいて評価できる、共有され、アクセス権を持つセグメントのみが一覧表示されます。

   1. **[!UICONTROL 指標を使用して新しいセッションを開始]** ドロップダウンメニューから指標を選択します。 または、左側のパネルの ![&#x200B; ここに指標をドロップ &#x200B;](/help/assets/icons/Event.svg) のイベント **&#x200B;**&#x200B;指標 **[!UICONTROL _から指標をドラッグ&amp;ドロップすることもできます_]**。 選択した指標によって、新しいセッションの開始が定義されます。複数の指標を定義できます。
      ...
      次に、ドラッグ&amp;ドロップするか、指標として **[!UICONTROL ローンチ]** 指標を選択して新しいセッションを定義します。
