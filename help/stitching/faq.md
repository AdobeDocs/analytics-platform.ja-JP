...
+++**1 つ以上のイベントの「一時的な ID」フィールドに「未定義」などのプレースホルダー値が含まれている場合はどうなりますか？**
...
+++**Customer Journey Analyticsのステッチデータセットの指標は、Customer Journey Analyticsの未ステッチデータセットの同様の指標およびAdobe Analyticsと比較してどうですか？**
