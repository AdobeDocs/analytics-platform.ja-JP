...
>title="指標のステッチ"
>abstract="ステッチ指標は、過去 7 日間のイベントタイムスタンプを含むサンプルデータセットを使用して計算されます。<br> 通常、このサンプルデータセットは **[!UICONTROL プレビュー]** テーブルで使用されるサンプルデータとは異なります。"
...
**[!UICONTROL ステッチ指標]** は、過去 7 日間のイベントタイムスタンプを含むサンプルデータセットを使用して計算されます。 このサンプルデータセットは、通常、**[!UICONTROL プレビュー]** テーブルで使用されるサンプルデータとは異なります。 指標のステッチは、次の詳細を提供します。
