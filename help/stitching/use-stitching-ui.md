...
>title="指標のステッチ"
>abstract="ステッチ指標は、（今日のデータを含まない）過去 7 日間のサンプルデータセットを使用して計算されています。"
...
>additional-url="https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-16444" text="ステッチと不正な ID"
