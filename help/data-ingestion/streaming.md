...
- **HTTP API ソースコネクタを使用** を使用すると、Adobe Experience Platformで設定したデータセットに簡単にデータをストリーミングできます。
...
>[!NOTE]
>
>これは、ストリーミングデータをAdobe Experience Platformに取り込み、Customer Journey Analyticsで使用する方法を簡単に説明するガイドです。 を参照する際に、追加情報を調べることを強くお勧めします。
...
4. 内 [!UICONTROL 認証] 手順 [!UICONTROL データを追加] 画面：
   ...
   選択 **[!UICONTROL XDM 互換]** を使用して、ストリーミングするデータに、既存の XDM スキーマとの互換性があることを示します。
