...
![モバイルスコアカードのデモを示す Analytics スコアカードの例](assets/intro_scorecard.png)

このスコアカードのキュレーターは、スコアカードビルダーを使用して、エグゼクティブ消費者のスコアカードに表示するタイルを構成できます。 また、タイルをタップした後に詳細ビューや分類を調整する方法も設定できます。スコアカードビルダーインターフェイスを次に示します。

![新しいモバイルスコアカードウィンドウが表示されるスコアカードビルダー。 ](assets/scorecard_builder.png)
...
![「空白モバイル・スコアカード」が選択された「すべてのテンプレート」ウィンドウ。](assets/new_template.png)
...
1. 右側のパネルの「**[!UICONTROL プロパティ]**」で、使用するデータの元となる&#x200B;**[!UICONTROL プロジェクトデータビュー]**&#x200B;を指定します。
   ...
   ![データビューの選択をハイライトする新しいモバイルスコアカードウィンドウ](assets/properties_save.png)

1. スコアカードに新しいタイルを追加するには、左のパネルから指標をドラッグし、 **[!UICONTROL ここに指標をドラッグ&amp;ドロップ]** ゾーン。 同様のワークフローを使用して、2 つのタイル間に指標を挿入することもできます。

   ![スコアカードにドロップされた指標（新しい KPI）を示す矢印が付いた新しいモバイルスコアカードウィンドウ。 ](assets/build_list.png)
...
![ディメンションリストからスコアカードウィンドウを指す矢印が付いた、新しいモバイルスコアカードウィンドウ。](assets/layer_dimensions.png)
...
![昨日と前日を強調した新しいモバイルスコアカードと、比較日を含む](assets/include-comparison-dates.png)

この設定は、デフォルトで&#x200B;*オン*&#x200B;になっています。比較日付を表示しない場合は、*オフ*&#x200B;に切り替えます。

![昨日と比較日を含むをハイライトした新しいモバイルスコアカード](assets/no-comparison-dates.png)
...
![概要番号ビジュアライゼーションで 13.3K 訪問を強調表示する新しいモバイルスコアカード](assets/summary-number.png)

### [!UICONTROL ドーナツ]

このビジュアライゼーションは、円グラフと同様に、データを全体の一部として表示します。合計に対する割合を比較する際にドーナツグラフを使用します。例えば、個別ユーザーの合計数に貢献した広告プラットフォームを確認するとします。

![ドーナツグラフビジュアライゼーションを表示する新しい映画スコアカード](assets/donut-viz.png)
...
![横棒を表示する新しいモバイルスコアカード](assets/horizontal.png)

### [!UICONTROL 未指定]ディメンション項目を削除
...
スコアカードに名前を付けるには、画面の左上にある名前空間をクリックし、新しい名前を入力します。
