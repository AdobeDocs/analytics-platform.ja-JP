...
**[!UICONTROL 純増加率]** 表示タイプは、特定の期間におけるユーザーの増加率または減少率に関するインサイトを提供します。 水平軸は時間間隔、垂直軸は成長の測定です。
...
[ アクティブ ](active.md) ビュータイプと同様に、ユーザーは次のように定義されます。
...
* **[!UICONTROL 表示]**：この表示タイプと [ アクティブ ](active.md) を切り替えます。
