...
| [!UICONTROL **プロジェクト**] | 保存済みの Workspace プロジェクト名、API レポート ID など（メタデータはアプリケーションによって異なる場合があります）。<p>**注意：** この列の値が [!UICONTROL **不明**]&#x200B;ということは、プロジェクトが保存されていないか、ユーザーが要求メタデータを使用できないことを意味します。</p> |
