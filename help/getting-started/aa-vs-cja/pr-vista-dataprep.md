---
title: 処理ルール、VISTA および分類と Analytics ソースコネクタ用の Data Prep
...
* **データの一般的な変換**。データ準備には、Analytics ソースコネクタを介して受信するデータに基づいて新しいフィールドを計算し、計算するために使用できる、数百ものマッピング関数があります。 区切られたフィールドを別のフィールドに分割できます。フィールドを組み合わせることができます。文字列を操作できます。正規表現に基づいてフィールドから情報を抽出できます。他にも、様々なことができます。
