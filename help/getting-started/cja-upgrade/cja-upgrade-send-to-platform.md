...
| <span class="preview">**手順 3:Adobe Experience Platformへのデータの送信**</span> | <span class="preview">Adobe Experience Platformにデータを送信するプロセスは、手順 2 で選択したアップグレードパスによって異なります。</span> |
...
各アップグレードパスのデータをExperience Platformに送信するプロセスを以下に示します。 次の表に示すリンクを参照して、詳細な設定情報を確認します。

| アップグレードパス | Platform へのデータ送信プロセス | 追加情報 |
|---------|----------|----------|
...
次に、あなたがする方法を決定 [Adobe Analyticsの履歴データを保持](/help/getting-started/cja-upgrade/cja-upgrade-historical-data.md).
