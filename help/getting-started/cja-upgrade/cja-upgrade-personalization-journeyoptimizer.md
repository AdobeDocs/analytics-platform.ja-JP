...
>abstract="パーソナライズされた最適化では、教師あり機械学習とディープラーニングの最先端テクノロジーを活用することで、ビジネスユーザー（マーケター）がビジネス目標を定義し、顧客データを利用してビジネス指向のモデルをトレーニングし、パーソナライズされたオファーを提供して KPI を最大化できます。"

<!-- markdownlint-enable MD034 -->

{{upgrade-note}}

パーソナライズされた最適化では、教師あり機械学習とディープラーニングの最先端テクノロジーを活用することで、ビジネスユーザー（マーケター）がビジネス目標を定義し、顧客データを利用してビジネス指向のモデルをトレーニングし、パーソナライズされたオファーを提供して KPI を最大化できます。
