...
Customer Journey Analytics を利用できるのは、次の条件を満たすお客様です。
...
| **手順 4：データビューの作成** | データビューは、データの「フィルタリングされた」ビューです。 同じ接続に対して、訪問タイムアウトやアトリビューションなどの設定を異なるデータビューを作成できます。単一のデータセットに対して複数のデータビューを作成できます。<br>[データビューの作成](/help/data-views/create-dataview.md)を参照してください。 |
