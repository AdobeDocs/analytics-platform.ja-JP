...
| タスク | 詳細 |
| --- | --- |
| **手順 1：Adobe Analytics から CJA に移行する場合は、何を行うかを学ぶ。** | 詳しくは、[Customer Journey Analytics での Adobe Analytics レポートスイートデータの利用](/help/getting-started/aa-vs-cja/aa-data-in-cja.md)を参照してください。 |
