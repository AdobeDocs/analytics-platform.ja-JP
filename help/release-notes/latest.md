...
| **プロファイルおよび参照データの参照のサポートが拡張されました。** | プロファイルまたは参照データセット内のフィールドの参照としてデータセットを追加する機能を提供します。 以前は、イベントデータセットのみがサポートされていました。 [詳細情報](/help/connections/create-connection.md) | 2023年6月21日（PT） | 2023年7月12日（PT） |
