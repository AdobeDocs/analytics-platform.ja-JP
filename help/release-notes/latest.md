...
| **イベントの深度ディメンション** | 新しい [ イベントの深度 ](https://experienceleague.adobe.com/ja/docs/analytics-platform/using/cja-dataviews/component-reference#required-standard-components) ディメンションが、データビューに必要な標準コンポーネントのリストに追加されました。 |  | 2025年5月8日（PT） |
