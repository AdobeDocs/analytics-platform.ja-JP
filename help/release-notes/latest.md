...
| **Content Analytics：散布図ビジュアライゼーションのサムネールとプレビュー** <p>[ サムネールとプレビュー ](/help/content-analytics/report/report.md) は、Content Analyticsの散布図ビジュアライゼーションのアセットとエクスペリエンスで使用できます。</p> | 2026年2月17日（PT） | 2026年3月2日（PT） |
| **Content Analytics：棒グラフビジュアライゼーションのサムネールとプレビュー** <p>[ サムネールとプレビュー ](/help/content-analytics/report/report.md) は、Content Analyticsの棒グラフ（積み重ね）および横棒グラフ（積み重ね）のビジュアライゼーションのアセットとエクスペリエンスで使用できます。</p> | 2026年2月23日（PT） | 2026年3月9日（PT） |
