...
| -----------|-----------|-----------|
| **ブランドの可視性統合**<br>&#x200B;ブランドの可視性インバウンド統合](/help/integrations/bv.md#inbound-integration)を使用すると、ブランドの可視性データをCustomer Journey Analyticsに取り込んで詳しく分析できます。[ | 2026年7月28日（PT） | 2026年7月28日（PT） |
