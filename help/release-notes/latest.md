...
| **Customer Journey Analytics 向けの AI アシスタント** | Customer Journey Analytics UI で自然言語の質問をし、Customer Journey Analytics ドキュメントに基づいて回答を得ることができます。 <p>（更新されたドキュメントへのリンクを添付）</p> | | 2024年5月30日（PT） |
