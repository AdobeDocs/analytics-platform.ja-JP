...
| --- | --- |
| **2025年9月** | |
| 使用インターフェイス | 接続に更新された [ 使用インターフェイス ](/help/connections/manage-connections.md#usage) のドキュメントを追加しました。 |
| Journey Optimizer データセットのステッチ | ステッチで使用できるドキュメント化された [ 自動生成されたジャーニー最適化データセットのリスト ](/help/stitching/overview.md#journey-optimizer-datasets)。 |
