---
title: Customer Journey Analytics ドキュメントのアップデート
...
Customer Journey Analyticsドキュメントの開始以降、次の更新がおこなわれました。
...
| --- | --- |
| **2023年6月** | |
| クロスチャネル分析とステッチ | ステッチを有効にするための今後の変更を見越し、ステッチを使用してクロスチャネル分析を高める方法をさらに明確にするために、クロスチャネル分析機能に関するドキュメントを編集し、 [クロスチャネル分析](../use-cases/cross-channel/cross-channel.md) をCustomer Journey Analytics機能および使用例として、および [ステッチ](../stitching/overview.md) これを達成する重要な機能として |
...
| 計算指標の更新 | 計算指標のドキュメントを現在の指標の機能に合わせるために、次の更新がおこなわれました。Customer Journey Analytics <ul><li>次のリストを更新しました： [デフォルトの計算指標](/help/components/calc-metrics/default-calcmetrics.md) Customer Journey Analytics</li><li>様々な計算指標に関する記事のスクリーンショットと手順を更新しました </li></ul> |
| **2023年5月** | |
...
| 最適化の更新 | 次に関する記事を更新しました： [Customer Journey Analyticsパフォーマンスの最適化](/help/admin/optimizing-performance.md) |
...
| プロジェクトフィルター（アドホックおよびクイックフィルター） | プロジェクトフィルターに関するドキュメントを合理化し、重複した情報を削除しました。 アドホックフィルターの作成手順は、[クイックフィルターの作成](/help/components/filters/quick-filters.md)手順と統合しました。 |
| **2023年3月** | |
| 意思決定管理データの統合 | 次の方法を説明する内容を追加しました。 [Adobe Journey Optimizer Decision Management データのCustomer Journey Analytics](/help/integrations/ajo-od.md). |
...
| 更新された機能のサポート | 更新済み [Customer Journey Analytics機能のサポート](/help/getting-started/aa-vs-cja/cja-aa.md) とは、Customer Journey Analyticsでは使用できるが、AA では使用できない、またはサポートされていない機能のテーブルを指します。 |
...
| Audiences ドキュメントの更新 | オーディエンスを作成した後、AdobeはExperience Platformを作成します [新しいCustomer Journey Analyticsオーディエンスごとのストリーミングセグメント](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=ja#after-audience-created). |
...
| モバイルスコアカード | 比較日付範囲の表示／非表示を切り替える方法について説明する新しい節をドキュメントに追加しました。詳しくは、 [比較日付範囲を表示](/help/mobile-app/create-scorecard.md#show-comparison-dates) Customer Journey Analytics |
| **2023年1月** | |
...
| データ取り込みクイックスタートガイド | 方法に関する新しいドキュメントの節 [データの取り込みと使用](/help/data-ingestion/data-ingestion.md) Customer Journey Analytics |
...
| プロファイルおよびルックアップデータセットでのオブジェクト配列のサポート | 更新済み [オブジェクトの配列の使用](/help/use-cases/object-arrays.md) および [Adobe Experience Platformオーディエンスの取り込み](/help/use-cases/data-ingestion/ingest-aep-segments.md) を使用して、プロファイルと参照のデータセットに対するオブジェクト配列のサポートを反映させます。 |
...
| --- | --- |
| **2022年12月** |  |
| 2022年12月16日（PT） | に関する新しいトピックです。 [Customer Journey Analyticsデータ使用量の測定と管理](/help/admin/estimate-usage.md). |
| **2022年10月** | |
...
| 2022年10月 | に関する新しいトピックです。 [Customer Journey Analytics監査ログ](/help/privacy/audit-log.md). |
...
| **2022年9月** | |
| 2022年9月 | の新しい使用例 [Google AnalyticsデータからCustomer Journey Analyticsへの移行](/help/use-cases/ga/overview.md). |
...
| 2022年8月 | 次の記事を大幅に更新しました： [Customer Journey Analyticsアクセス制御](/help/admin/cja-access-control.md). |
| 2022年8月 | に関する新しい記事を追加しました。 [Customer Journey Analyticsでのデータガバナンスラベルとポリシーのサポート](/help/data-views/data-governance.md). |
...
| 2022年6月 | に関する新しい記事を追加しました。 [Adobe AnalyticsとCustomer Journey Analyticsのレポート機能でのデータ処理の比較](/help/getting-started/aa-vs-cja/data-processing-comparisons.md). |
...
| 2022年6月 | に関する新しい記事を追加しました。 [Customer Journey Analyticsの Analytics Labs](/help/labs/labs.md). |
...
| **2022年5月** | |
| 2022年5月 | 次の記事を大幅に更新しました： [接続の作成](/help/connections/create-connection.md) Customer Journey Analytics |
| 2022年5月 | 次の方法に関する新しい記事を追加しました。 [Customer Journey AnalyticsReport Builderでのデータブロックの管理](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html?lang=ja). |
| 2022年5月 | に関する新しい記事を追加しました。 [Adobe Experience PlatformオーディエンスのCustomer Journey Analyticsへの取り込み](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **2022年4月** | |
...
| 2022年4月 | 新規 [Adobe Analyticsユーザー向けCustomer Journey Analyticsユーザーガイド](/help/getting-started/aa-to-cja-user.md). |
| **2022年3月** | |
| 2022年3月 | 新規 [Customer Journey Analytics注釈 API ドキュメント](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/). |
...
| **2022年2月** | |
| 2022年2月 | Adobe AnalyticsからCustomer Journey Analyticsに移行する管理者を対象とした新しいガイドです。 [Adobe AnalyticsからCustomer Journey Analyticsへの進化](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/aa-to-cja.html?lang=ja) |
| **2022年1月** | |
| 2022年1月 | の新しい使用例 [Customer Journey Analyticsでのディメンションと指標のバインディングの使用](/help/use-cases/data-views/binding-dimensions-metrics.md) |
...
| 2022年1月 | に関する新しい記事を追加しました。 [Customer Journey AnalyticsでのAdobe Analyticsデータと Analytics データの比較](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=ja) |
...
| --- | --- |
| **2021年11月** | |
| 2021年11月 | 接続の詳細ページの詳細ページ「[[!UICONTROL スキップされたレコード]](/help/connections/manage-connections.md)」のドキュメントを更新しました。 |
| **2021年10月** | |
| 2021年10月 | のドキュメント [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html?lang=ja#) Customer Journey Analytics |
...
| 2021年9月 | 新しいセクション ( [レポートスイートの結合の影響](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=ja#6-considerations-when-merging-report-suites-in-cja) Customer Journey Analytics |
| **2021年8月** | |
| 2021年8月 | 拡張された [接続](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=ja) エクスペリエンス (Customer Journey Analytics) |
...
| 2021年4月 | に関する新しいトピックです。 [Customer Journey Analyticsの高基数次元](/help/components/dimensions/high-cardinality.md). |
| **2021年3月** | |
...
| 2021年2月 | 新しい [Customer Journey AnalyticsAPI](https://www.adobe.io/cja-apis/docs/) ドキュメント。 |
| **2021年1月** | |
...
| 2019年12月 | Customer Journey Analyticsドキュメントの最初のドラフト |
