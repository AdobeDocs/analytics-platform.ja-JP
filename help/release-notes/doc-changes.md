...
|---|---|
| **2026年5月** | |
| Content Analyticsのタグに依存しない設定 | Experience Platform Data Collection Tagsを必要とせずにweb チャネルにContent Analyticsを実装する方法については、[ ドキュメント ](/help/content-analytics/config/tags-agnostic.md)を参照してください。 |
