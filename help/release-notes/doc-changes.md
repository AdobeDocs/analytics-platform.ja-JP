...
|---|---|
| **2026年5月** | |
| Content Analytics用Javascript ライブラリ | Experience Platform Data Collection Tagsを必要とせずに[Content Analytics Javascript ライブラリ ](/help/content-analytics/config/tags-agnostic.md)を使用してweb チャネルにContent Analyticsを実装する方法に関するドキュメント。 |
| Data Mirrorの考慮事項 | [Data Mirror データセット ](/help/data-mirror/data-mirror.md)を設定する際に考慮すべき要素を説明する[ ドキュメント ](/help/data-mirror/considerations.md)です。 |
| Content Analytics mobile channel | Content Analytics モバイルチャネルの機能と設定について説明する[Content Analytics ドキュメント ](/help/content-analytics/content-analytics.md)を更新しました。 |
| **2026年4月** | |
| 派生フィールドガイドライン | 派生フィールドを操作するための[ ガイドライン ](/help/use-cases/data-views/derived-fields/guidelines.md)付きの記事（ベストプラクティス、ガードレール、一般的な落とし穴）を追加しました。 |
| Journey Optimizerの統合時に含めることができる2つのデータセットに関する不足しているドキュメントを追加しました | [IMS組織で高スループットトランザクションメッセージアドオンが有効になっている場合、プロファイル以外のシステム生成データセット ](/help/integrations/ajo.md#high-throughput-add-on-datasets)が2つ追加で接続に含まれます。 |
| コホート分析のユースケースを更新 | コホート分析のユースケースに追加されたAnalyis Workspaceの例は、フィードバックにもとづいています。 |
| **2026年3月** | |
| パネルの分割 | 新しい[分類](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel)機能をサポートするために、パネル ](/help/analysis-workspace/c-panels/panels.md#drop-zone)の[ ドロップゾーンに関するドキュメントを再構築しました。 |
| 不正なID （BAVIDs）に関するテクニカルノート | 不正なID](/help/technotes/badids.md)に関する新しい[ テクニカルノート。 このテクニカルノートでは、不正なIDの定義、Customer Journey Analytics インターフェイスの不正なIDの使用場所、および不正なIDの接続内のデータを調査する方法について説明します。 |
| Connectionsでのデータセットのプレビューの再設計 | 個人ベースの接続で[追加](/help/connections/create-connection.md#add-datasets)または[編集](/help/connections/create-connection.md#edit-a-dataset) データセットを追加した場合のデータプレビューエクスペリエンスの向上に関するドキュメントを更新しました。ステッチが有効なデータセットのプレビュー情報](/help/stitching/use-stitching-ui.md#datasets-preview)を[つなぎ合わせることについてのドキュメントを含みます。 |
| Content Analyticsのサムネールとプレビュー | Content Analyticsのその他のビジュアライゼーションについては、[ サムネール ](/help/content-analytics/report/report.md#thumbnails)および[ プレビュー](/help/content-analytics/report/report.md#previews)に関するドキュメントを参照してください。 |
| **2026年2月** | |
| ヘッダーの上書き | Content Analyticsの設定](/help/content-analytics/config/guided.md#header-overrides)を上書きする追加の[ ヘッダーに関するドキュメント。 |
| 計算指標ガードレール | 組織](/help/technotes/guardrails.md#segments-and-calculated-metrics)の計算指標の最大数に関する[ ガードレールを更新しました。 最大値は50,000です。 |
| スタンドアロン Content Analytics | Content Analytics](/help/content-analytics/config/standalone.md)の[ スタンドアロン設定のドキュメントを追加しました。 |
| **2026年1月** | |
| スキーマを設計 | [Customer Journey Analyticsで使用するスキーマを設計する](/help/getting-started/cja-upgrade/cja-upgrade-schema-architect.md)に、重要な情報とコンテキストを追加しました。 |
...
| --- | --- |
| **2025年12月** | |
| サンドボックスの変更の影響 | サンドボックスの削除またはリセットの影響を[削除およびリセットの影響](/help/technotes/deletion.md)記事に追加しました。 |
| **2025年11月** | |
...
| 接続 | 今後のカスタマージャーニー B2B Edition に関するカスタマージャーニー接続のドキュメントを修正して更新しました。 |
...
| 用語の変更：「フィルター」から「セグメント」へ | 以前、Adobe Customer Journey Analytics では、セグメントを「フィルター」と呼んでいました。 この用語は Adobe Analytics の用語と統一されました。 「フィルター」は「セグメント」と呼ばれるようになりました。 （明らかに、検索フィルターは依然として「フィルター」と呼ばれます）。 UIとドキュメントが更新されました。 |
| **2025年3月** | |
...
| 2021年9月 | Customer Journey Analytics における[レポートスイートの結合の影響](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html#6.-considerations-when-merging-report-suites-in-cja)に関する新しい節。 |
| **2021年8月** | |
