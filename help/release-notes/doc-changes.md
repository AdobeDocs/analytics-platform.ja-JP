...
| キーへのAdobe Azure アプリのアクセスを許可する別の方法 | Azure 上のCustomer Journey Analyticsに対して [ 顧客管理キーを設定 ](/help/privacy/cmk.md#set-up-customer-managed-keys-for-customer-journey-analytics-on-azure) する際に、認証の同意を通じて権限を付与する方法に関する情報を追加しました。 |
| **2025年6月** | |
