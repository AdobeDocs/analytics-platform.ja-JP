...
| ガイド付き分析 | ガイド付き分析内からの [ ガイド付き分析 ](/help/guided-analysis/overview.md) の可用性をドキュメントに更新しました。 |
...
| **2024年10月** | |
| ジャーニーキャンバスビジュアライゼーション | [ジャーニーキャンバス ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/journey-canvas/journey-canvas?lang=en) は、ユーザーが定義されたジャーニーをどのように進めたり、そこから離脱したりするかを分析できる、Analysis Workspace のビジュアライゼーションです。 |
| アセット転送 | プロジェクト、フィルター、計算指標などのコンポーネントの [ 所有権 ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/tools/asset-transfer/transfer-assets) を他のユーザーに転送し、連続性を持たせ、適切なアクセス権を持たせることができます。 |
...
| オーディエンスドキュメントの更新 | Analysis Workspace内のビジュアライゼーションから [ オーディエンスを作成 ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-components/audiences/publish?lang=en) する際に、パネルフィルターと列フィルターが追加の条件として含まれるようになりました。 |
| **2024年9月** | |
...
| 計算指標マネージャーとフィルターマネージャーの「使用されている場所」列に表示される追加情報 | [ 計算指標マネージャー ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-components/cja-calcmetrics/cm-workflow/cm-manager?lang=en) および [ フィルターマネージャー ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-components/cja-filters/manage-filters?lang=en) の「使用されている場所」列には、Report Builderコンポーネントとアドホックコンポーネントの新しいレポート領域が含まれています |
| **2024年8月** | |
