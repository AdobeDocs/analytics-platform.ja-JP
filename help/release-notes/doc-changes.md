...
|---|---|
| **2026年3月** | |
| 不正な ID （BAVID）に関するテクニカルノート | 無効な ID に関する新しいテクニカルノート。 このテクニカルノートでは、不正な ID の定義、Customer Journey Analytics インターフェイスで不正な ID を使用する場所および不正な ID に関する接続データを調査する方法について説明します。 |
