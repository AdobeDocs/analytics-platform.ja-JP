...
| **2026年3月** | |
| パネルの分割 | 新しい[分類](/help/analysis-workspace/c-panels/panels.md#drop-zone)機能をサポートするために、パネル [の](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel) ドロップゾーンに関するドキュメントを再構築しました。 |
| 不正なID （BAVIDs）に関するテクニカルノート | 不正なID[に関する新しい](/help/technotes/badids.md) テクニカルノート。 このテクニカルノートでは、不正なIDの定義、Customer Journey Analytics インターフェイスの不正なIDの使用場所、および不正なIDの接続内のデータを調査する方法について説明します。 |
| Connectionsでのデータセットのプレビューの再設計 | 個人ベースの接続で[追加](/help/connections/create-connection.md#add-datasets)または[編集](/help/connections/create-connection.md#edit-a-dataset) データセットを追加した場合のデータプレビューエクスペリエンスの向上に関するドキュメントを更新しました。ステッチが有効なデータセットのプレビュー情報[を](/help/stitching/use-stitching-ui.md#datasets-preview)つなぎ合わせることについてのドキュメントを含みます。 |
...
| **2026年2月** | |
| ヘッダーの上書き | Content Analyticsの設定[を上書きする追加の](/help/content-analytics/config/guided.md#header-overrides) ヘッダーに関するドキュメント。 |
| 計算指標ガードレール | 組織[の計算指標の最大数に関する](/help/technotes/guardrails.md#segments-and-calculated-metrics) ガードレールを更新しました。 最大値は50,000です。 |
| スタンドアロン Content Analytics | Content Analytics[の](/help/content-analytics/config/standalone.md) スタンドアロン設定のドキュメントを追加しました。 |
| **2026年1月** | |
