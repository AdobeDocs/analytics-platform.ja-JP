...
|---|---|
| **2026年3月** | |
| 不正な ID （BAVID）に関するテクニカルノート | 新しい [&#x200B; 無効な ID に関するテクニカルノート &#x200B;](/help/technotes/badids.md)。 このテクニカルノートでは、不正な ID の定義、Customer Journey Analytics インターフェイスで不正な ID を使用する場所および不正な ID に関する接続データを調査する方法について説明します。 |
| 接続でのデータセットのプレビュー再設計 | ユーザーベースの接続でデータセットを [&#x200B; 追加 &#x200B;](/help/connections/create-connection.md#add-datasets) または [&#x200B; 編集 &#x200B;](/help/connections/create-connection.md#edit-a-dataset) する際のデータプレビューエクスペリエンスを向上させるために、ドキュメントを更新しました。これには、ステッチが有効なデータセットの追加 [&#x200B; ステッチプレビュー情報 &#x200B;](/help/stitching/use-stitching-ui.md#datasets-preview) に関するドキュメントが含まれます。 |
| Content Analyticsのサムネールとプレビュー | Content Analyticsのその他のビジュアライゼーションの [&#x200B; サムネール &#x200B;](/help/content-analytics/report/report.md#thumbnails) および [&#x200B; プレビュー &#x200B;](/help/content-analytics/report/report.md#previews) に関するドキュメント。 |
| **2026年2月** | |
| ヘッダーの上書き | Content Analyticsの追加の [&#x200B; ヘッダーオーバーライド設定 &#x200B;](/help/content-analytics/config/guided.md#header-overrides) に関するドキュメント。 |
| 計算指標ガードレール | [&#x200B; 組織の計算指標の最大数のガードレール &#x200B;](/help/technotes/guardrails.md#segments-and-calculated-metrics) を更新しました。 最大値は現在 50,000 です。 |
| スタンドアロン Content Analytics | [Content Analyticsのスタンドアロン設定 &#x200B;](/help/content-analytics/config/standalone.md) に関するドキュメントを追加しました。 |
| **2026年1月** | |
