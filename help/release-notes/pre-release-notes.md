...
このリリースノートは、2025年6月2日～2025年7月15日（PT）のリリース期間を対象としています。Adobe Customer Journey Analytics リリースは[継続的デリバリーモデル ](releases.md)で動作します。これにより、機能のデプロイメントに対するよりスケーラブルで段階的なアプローチが可能になります。
