...
| **セッションレポートを返す** | 特定のセッションがユーザーのリターンセッションであったかどうかを検出します。 [詳細情報](/help/data-views/data-views-usecases.md) | 2022年9月14日（PT） |
...
| **Workspace での複合グラフのビジュアライゼーション** | 複合グラフを使用すると、Workspace 内で指標をより簡単かつ直感的に比較できます。[詳細情報](/help/analysis-workspace/visualizations/combo-charts.md) | 2022 年 9 月 14 日から段階的なロールアウトが開始されます |
