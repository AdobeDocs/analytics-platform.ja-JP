...
| **スケジュールされたプロジェクトのパスワード保護** | この機能は、HIPAA 対応の一部であり、Healthcare Shield のお客様にのみ適用されます。[詳細情報](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/export/t-schedule-report.html#password) | 該当なし | 2022年11月7日（PT） |
