...
>[!AVAILABILITY]
>
>この記事で説明されている機能は、2025 年 5 月 28 日（PT）以降の段階的リリースの一部として適格なすべての顧客が利用できますが、お使いの環境ではまだ利用できない場合があります。 機能が一般に利用できるようになったら、このメモは削除されます。Customer Journey Analytics リリースプロセスについて詳しくは、[Customer Journey Analytics機能リリース ](/help/release-notes/releases.md) を参照してください。
