...
>title="Journey Optimizer接続の使用"
>abstract="は、Journey Optimizerで高度なCustomer Journey Analytics レポート機能を活用します。"

>[!CONTEXTUALHELP]
>id="connections_cancel_ajo"
>title="Journey Optimizer接続のキャンセル"
>abstract="Journey Optimizerの高度なCustomer Journey Analytics レポート機能をキャンセルします。"
