...
>title="法的影響"
>abstract="Customer Journey Analyticsを使用すると、統合データボリュームに基づいて追加の変更が行われる場合があります。 詳しくは [Customer Journey Analyticsの請求と使用方法の詳細 &#x200B;](https://experienceleague.adobe.com/ja/docs/analytics-platform/using/cja-connections/manage-connections#connections-usage) を参照してください。"
