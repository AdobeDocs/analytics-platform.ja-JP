...
接続を作成する際に、ルックアップ用に大規模なデータセットを追加できます。例えば、製品カタログを表すデータセットを使用すると、レポートやビジュアライゼーションの作成時に説明的な製品情報を検索できます。 このような大規模なルックアップデータセットは、現在ガードレールとして実装されている一意のルックアップの最大数が 1,000 万件を超え、追加のデータがスキップされる可能性があります。
