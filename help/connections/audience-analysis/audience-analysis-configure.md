...
1. 接続を設定するには、次の情報を指定します。
   ...
   | **[!UICONTROL アカウント ID]** [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/ja/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B Edition"} | （アカウントベースの接続でのみ表示）データセットのアカウントベースのレポートをサポートするために使用されるアカウント ID。 |
