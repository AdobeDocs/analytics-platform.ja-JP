...
description: セグメント作成のユーザーインターフェイスについて。
...
Customer Journey Analyticsでは、さまざまなタイプのセグメントを作成できます。  選択するタイプは、セグメントの複雑さ、およびセグメントを現在のWorkspace プロジェクトにのみ適用するか、すべてのプロジェクトに適用するかによって異なります。 セグメントは、Customer Journey Analyticsのメインインターフェイスで直接作成することも、Workspace プロジェクトで作業する場合にも作成できます。
