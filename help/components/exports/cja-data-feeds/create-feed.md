...
* ルックバック日付範囲と頻度ウィンドウは、Analysis Workspace レポート日付範囲と同様に機能します。 ただし、[主な違い](/help/components/exports/cja-data-feeds/df-comparison-workspace.md#differences)があります。 このような違いにより、Workspace レポートとデータフィードの配信の間でデータの相違が生じる可能性があります。

ルックバック日付範囲内でデータを処理する場合、セグメントの選定、セッション計算、ディメンションの永続性、派生フィールドの変換がそれぞれ考慮されます。
