...
クラウドの書き出し場所とアカウントを表示、編集および削除できます。
...
1. 「[!UICONTROL **Locations**]」タブを選択します。
   ...
   ![ 「場所」タブと場所のリストを表示する書き出しウィンドウ。](assets/locations-manager.png)

1. （条件付き）システム管理者の場合は、「[!UICONTROL **すべてのユーザーの場所を表示**] オプションを有効にして、組織内のすべてのユーザーが作成した場所を表示できます。

1. 編集する場所を選択します。

1. 画面の下部にある「[!UICONTROL **編集**]」を選択します。
...
1. 画面の下部にある「[!UICONTROL **削除**]」を選択します。
...
1. 編集するアカウント上にある 3 ドットアイコンを選択し、「[!UICONTROL **キーを表示**] を選択します。
...
1. 削除するアカウント上にある 3 ドットアイコンを選択し、「[!UICONTROL **アカウントを削除**] を選択します。
...
ユーザーによるアカウントの作成を制限できます。 その場合、ユーザーは作成済みの任意のアカウントを引き続き使用できますが、編集はできません。 [ アカウントの削除 ](#delete-accounts) で説明しているように、ユーザーが作成したアカウントを削除できます。
...
1. （任意）ユーザーが作成したアカウントのうち、使用を希望しないものについては、「[ アカウントの削除 ](#delete-accounts)」の説明に従って削除します。
...
ユーザーによる場所の作成を制限できます。 その場合、ユーザーは作成済みの任意の場所を引き続き使用できますが、編集できなくなります。 [ 場所の削除 ](#delete-locations) の説明に従って、ユーザーが作成した場所を削除できます。
...
1. （任意）ユーザーが作成した場所で、使用したくない場所を削除します。詳しくは、[ 場所の削除 ](#delete-locations) を参照してください。
...
1. [ アカウントの削除 ](#delete-accounts) の説明に従って、アカウントを削除します。
