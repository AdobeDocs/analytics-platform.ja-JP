...
>[!TIP]
>
>Ultimate パッケージの権利は付与されているが [ リアルタイム更新の切り替え ](use-real-time.md) が表示されない場合、カスタマーケアチケットを作成して、組織のリアルタイムレポートを有効にするようリクエストします。
...
![リアルタイムのレポート](assets/real-time-reporting-latencies.svg){zoomable="yes"}
