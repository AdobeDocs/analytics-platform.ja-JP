...
![ 列 1 （訪問回数）と列 2 （100）に適用された指標とバウンス率を示す概要ウィンドウ。](assets/cm_fbr.png)
...
![If and then フィルターにより、訪問別に並べ替えられたページのうち上位 30% のバウンス率を表示します。](assets/cm_wbr_2.png)
...
![ バウンス率と訪問回数の定義の概要。](assets/cm_wbr.png)
