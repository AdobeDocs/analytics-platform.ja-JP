...
次の 2 つの方法のいずれかを使用して、日付範囲を作成できます。
...
* **プリセットを選択**:Adobeがデフォルトで提供する範囲に基づいてカスタムの日付範囲を作成する場合は、このドロップダウン選択を使用します。 プリセットを選択すると、必要に応じて日付範囲をさらにカスタマイズできます。 アドビが提供するプリセットには影響しません。
