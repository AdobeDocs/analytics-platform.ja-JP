...
フィルターマネージャーにアクセスするには、 **[!UICONTROL カスタマージャーニー分析]** > **[!UICONTROL コンポーネント]** > **[!UICONTROL フィルター]** 」をクリックします。
