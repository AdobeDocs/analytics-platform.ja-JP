...
中央の [ セグメント ](filters-favorite.md) 管理インターフェイスから、(filters-share.md) 共有 [、](filters-tag.md) セグメント [&#128279;](filters-filter.md)、[ タグ ]、[ 承認 ](filters-approve.md)、名前変更、[ コピー ](filters-copy.md)、セグメントの削除、書き出し、およびセグメントを  お気に入りとしてマークできます 。 セグメントを管理するには：
