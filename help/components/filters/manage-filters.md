...
フィルターマネージャーでは、フィルターを様々な方法で管理できます。例えば、共有、タグ付け、承認、コピー、削除およびお気に入りへの登録が可能です。
...
フィルターの計画は時間をかけて行い、組織に役立つようにし、ユーザーの数を確認します。
...
フィルターマネージャでは、フィルターにタグを付けて管理できます。すべてのユーザーがフィルターのタグを作成し、1つ以上のタグをフィルターに適用できます。 ただし、自分が所有しているまたは自分が共有していたフィルターに対するタグのみを表示できます。
...
1. 「**[!UICONTROL 未承認]**」をクリックして、承認済みフィルターを未承認にすることもできます。
...
フィルターを使いやすく整理するための1つの方法として、ユーザーをお気に入りに登録することができます。
