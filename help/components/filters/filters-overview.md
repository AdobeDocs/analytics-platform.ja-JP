...
Customer Journey Analyticsでは、焦点を当てた強力なオーディエンスセグメントを作成、管理、共有し、レポートに適用できます。 フィルターを使用すると、特性やインタラクションに基づいて人物、セッションまたはイベントのサブセットを識別できます。 フィルターは、特定のニーズに合わせて作成し、他のチームメンバーと検証、編集、および共有できる、体系化されたオーディエンスインサイトとして作られています。
...
最も広く定義されたコンテナとして、人物コンテナレベルで生成されたレポートは、フィルターに該当するすべての人物のイベントおよびセッションを返します。 個人コンテナは、定義された日付範囲に基づいて最も変更されやすい要素です。
