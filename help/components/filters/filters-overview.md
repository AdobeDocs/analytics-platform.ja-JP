...
セッションコンテナでは、特定の セッションのページでのインタラクション、キャンペーンまたはコンバージョンを識別できます。セッションコンテナは、ルールに合致すると訪問セッション全体の行動を収集し、フィルターの作成と適用に含めるまたは除外するセッションを定義できるため、最も一般的に使用されるコンテナです。 次の質問に答えるのに役立ちます。
