...
| **以下を使用： [CJA 注釈 API](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/)** | CJA 注釈 API を使用すると、Adobe I/Oを通じて、注釈をプログラムで作成、更新、取得できます。これらの API は、製品 UI 内でAdobeが使用するのと同じデータおよびメソッドを使用します。 |
