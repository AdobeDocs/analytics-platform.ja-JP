...
>[!AVAILABILITY]
>
>この節で説明する棒グラフと散布図のビジュアライゼーションは、制限付きテストで使用でき、環境で使用できない場合があります。 このメモは、機能が一般に利用可能な場合に削除されます。 Customer Journey Analytics リリースプロセスについて詳しくは、[Customer Journey Analytics 機能リリース](/help/release-notes/releases.md)を参照してください。
>
