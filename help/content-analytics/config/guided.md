...
>title="データビュー"
>abstract="Content Analyticsの設定の場合、1 つ以上のデータビューを選択する必要があります。 そのため、コンテンツ分析データを他のデータと結合できます。"

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataviews_header"
>title="データビュー"
>abstract="Content Analytics データの結合先となるCustomer Journey Analyticsの既存のデータビューを 1 つ以上選択します。"

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataviews_header_alt"
>title="データビュー"
>abstract="Content Analytics データの結合先となるCustomer Journey Analyticsの既存のデータビューを 1 つ以上選択します。<br/>"

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataviews_new_dialog"
>title="選択されたデータビュー"
>abstract="この設定に対して選択したデータビューを変更しました。 選択したデータビューが更新され、Content Analyticsの指標とディメンションが含まれます。 これらの指標とディメンションは、選択されなくなった以前に選択したデータビューから削除されます。<br/><br/> 選択したデータビューに別の接続が関連付けられている場合、接続が更新され、Content Analytics データセットが含まれます。 コンテンツ分析データセットは、最初に選択した接続から削除されません。<br/><br/> 選択したすべてのデータビューは、この設定の一部であるチャネルを継承します。"
...
>title="選択されたデータビュー"
>abstract="この設定に対して選択したデータビューを変更しました。 選択したデータビューが更新され、Content Analyticsの指標とディメンションが含まれます。 これらの指標とディメンションは、以前に選択し削除されたデータビューから削除されます。<br/><br/> 選択したデータビューに別の接続が関連付けられている場合、接続が更新され、Content Analytics データセットが含まれます。 コンテンツ分析データセットは、最初に選択した接続から削除されません。<br/><br/> 選択したすべてのデータビューは、この設定の一部であるチャネルを継承します。"
...
>title="チャネル"
>abstract="設定用のチャネルを 1 つ以上有効にして設定します。"

>[!CONTEXTUALHELP]
>id="aca_onboarding_channels_header"
>title="チャネル"
>abstract="設定用のチャネルを 1 つ以上有効にして設定します。 設定に含まれるすべてのデータビューは、有効なチャネルを継承します。"
...
>title="Web ページのデータ収集"
>abstract="Content Analyticsのデータを収集する際に **含める** または **除外する** ページを指定します。"
