...
以下の節では、Content Analytics設定の実装の一環として、[Customer Journey Analytics](#customer-journey-analytics-cja)、[Experience Platform](#experience-platform-aep) および [ データ収集 ](#data-collection-dc) に適用される設定および設定について概説します。
