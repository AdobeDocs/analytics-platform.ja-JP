---
description: フリーフォームテーブルを含むフリーフォームパネルをAnalysis Workspace プロジェクトの開始状態として使用する方法を説明します。
title: フリーフォームパネル
feature: Panels
...
**[!UICONTROL フリーフォームパネル]**&#x200B;は、デフォルトの開始状態として[フリーフォームテーブル](/help/analysis-workspace/visualizations/freeform-table/freeform-table.md)ビジュアライゼーションが含まれている空白のパネルです。
