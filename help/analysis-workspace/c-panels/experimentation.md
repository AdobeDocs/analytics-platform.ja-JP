...
>title="実験"
>abstract="様々なユーザーエクスペリエンス、マーケティングまたはメッセージングのバリエーションを比較して、特定の結果を導く上で最適な判断を下すことができます。<br/><br/>**パラメーター&#x200B;**<br/>**実験**：分析される実験。<br>**バリアントの制御**：選択した実験のバリアントを制御します。<br/>**成功指標**：実験を分析するための最大 5 つの標準（計算されていない）成功指標。<br/>**指標の標準化**：人物、セッションまたはイベント。 この指標（カウント手法とも呼ばれます）は、上昇率計算の分母になります。この指標は、信頼性計算が適用される前のデータの集計方法にも影響します。"
