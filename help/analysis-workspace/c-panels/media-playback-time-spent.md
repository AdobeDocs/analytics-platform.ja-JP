...
>title="メディア再生に費やした時間"
>abstract="パネルを作成して、様々なレベルの精度で時間の経過に伴うビデオ消費を分析し、分類および比較できます。"
...
>title="メディア再生に費やした時間"
>abstract="ビデオ消費の推移を分析し、様々な精度を選択して、分類および比較します。<br/><br/>**精度**：同時視聴者数を表示する期間を選択します。<br/>**パネル要約数値（オプション）**：各行の日付または時間の詳細と共に要約数値を表示するオプション。 「最大」には、ピーク再生に費やした時間の詳細が表示されます。 最小値は、トラフの詳細を表示します。 合計には、再生に費やした合計時間の詳細が表示されます。<br/>**シリーズの分類（オプション）**：セグメント、ディメンション、ディメンション項目または日付範囲でビジュアライゼーションを分類します。 一度に最大 10 行を表示します。 分類は 1 つのレベルに制限されます。<br/>**時間形式**：ビジュアライゼーションの時間形式を時間または分で表示するオプション。"
