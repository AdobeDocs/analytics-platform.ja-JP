...
*この記事では、**Customer Journey Analyticsのメディア再生滞在時間パネルについて説明します**。 この記事の [2}Adobe Analytics](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/media-playback-time-spent) バージョンについては、**メディア再生滞在時間パネル* を参照してください。**
