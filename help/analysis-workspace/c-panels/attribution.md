...
1. [含まれるモデル &#x200B;](#attribution-models)から1つ以上の&#x200B;**[!UICONTROL 属性モデル]**&#x200B;を選択し、[&#x200B; コンテナ &#x200B;](#container)から&#x200B;**[!UICONTROL コンテナ]**&#x200B;を選択し、比較に使用する[&#x200B; ルックバックウィンドウ &#x200B;](#lookback-window)から&#x200B;**[!UICONTROL ルックバックウィンドウ]**&#x200B;を選択します。
