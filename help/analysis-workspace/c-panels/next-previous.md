...
>title="次または前の項目"
>abstract="パネルを作成して、ユーザーが来る以前のディメンションまたはユーザーが行く次のディメンションを理解します。"
...
>title="項目をネストまたは前の項目"
>abstract="訪問者が来訪前にいた場所または次に移動する場所として最も一般的なものを分析します。<br/><br/>**ディメンション**: Dimensionを選択します。 例えば **ページ** です。<br/>**Dimension項目**：特定のディメンション項目を選択します。 例えば、**ホームページ** などです。<br/>**方向**:「**次へ**」を選択すると、選択したディメンション項目の直後のディメンション項目が表示されます。 「**前へ**」を選択すると、選択したディメンション項目に至るディメンション項目が表示されます。<br/>**コンテナ**:「**セッション**」を選択して同じセッション内の次/前のディメンション項目を表示するか、「**ユーザー**」を選択して同じユーザーの次/前のディメンション項目を表示します。"
