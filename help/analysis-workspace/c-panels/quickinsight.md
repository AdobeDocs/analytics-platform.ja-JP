...
* 構築ブロックのドロップダウンメニュー（**[!UICONTROL Analyze]**&#x200B;の国など）を指定し、使用する値の可能な値のリスト（**[!UICONTROL ChevronRight]**&#x200B;を使用）を![検索](/help/assets/icons/ChevronRight.svg)します（**[!UICONTROL 国コード]**&#x200B;など）。
