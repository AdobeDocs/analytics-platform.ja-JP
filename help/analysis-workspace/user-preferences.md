---
title: ユーザー環境設定
description: ユーザーの一般的な環境設定とプロジェクト環境設定を行う方法について説明します。
...
| | デフォルトのテーブル指標 | <ul><li>イベント</li><li>セッション数</li><li>人物</li></ul> |
