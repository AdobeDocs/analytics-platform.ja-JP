...
| 機能 **[!UICONTROL ビジュアライゼーションのコピー]** どう？ | **[!UICONTROL ビジュアライゼーションのコピー]** は書き出しオプションではありません。 Workspace内のある場所から別の場所にビジュアライゼーションまたはパネルをコピーできます。 例えば、同じプロジェクト内のパネル間、または1つのプロジェクトから別のプロジェクト間などです。 下のビデオをご覧ください。 |
