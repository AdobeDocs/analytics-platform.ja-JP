...
| [!UICONTROL 有効期限] | デフォルトの有効期限は、スケジュールの頻度に応じて異なります。 以下の「予定されているプロジェクトの有効期限」を参照してください。 |
...
## スケジュール済みプロジェクトの有効期限 {#expiration}

スケジュールされたプロジェクトの有効期限は、スケジュールされた配信頻度に応じて異なります。

* 時間別の配信は、1 週間で期限が切れます。
* 毎日の配信は、1 ヶ月後に期限切れになります。
* 毎週の配信は 6 か月で期限が切れます。
* 月別/年別の配信は、1 年後に期限切れになります。
