...
* 受信者に役割が割り当てられていないがプロジェクトへの[リンク](/help/analysis-workspace/curate-share/shareable-links.md)を受け取った場合（**[!UICONTROL 共有]／[!UICONTROL プロジェクトリンクを取得]**）、そのユーザーはデフォルトで役割に配置されます。管理者が受け取る **[!UICONTROL 編集可能]** 管理者以外が受け取る **[!UICONTROL 複製可能]**.
