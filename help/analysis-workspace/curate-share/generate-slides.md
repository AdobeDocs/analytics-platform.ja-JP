...
>[!AVAILABILITY]
>
>データStorytellingは、[Data Insights Agent](/help/data-analysis-ai.md) の下のスキルです。 この機能は、リリースの限定的テスト段階にあり、お使いの環境ではまだ使用できない可能性があります。 機能が一般公開されたら、このメモは削除されます。Customer Journey Analytics リリースプロセスについて詳しくは、[Customer Journey Analytics 機能リリース](/help/release-notes/releases.md)を参照してください。
...
* ビジュアライゼーション
   ...
   * 複数のディメンション列を持つフリーフォームテーブル（単一のディメンション列を持つテーブルがサポートされます）
