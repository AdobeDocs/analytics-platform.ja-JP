...
title: Customer Journey Analyticsデータをメールで他のユーザーに送信する
...
# メールを使用して他のユーザーにCustomer Journey Analyticsデータを送信

選択した受信者にメールでCustomer Journey Analyticsレポートを送信すると、送信レポートを書き出すことができます。 アドホックでファイルを送信することも、スケジュールに従って送信するようにファイルを設定することもできます。 ファイルは CSV 形式または PDF 形式で送信できます。
