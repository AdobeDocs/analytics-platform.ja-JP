...
>title="マップビジュアライゼーションの設定"
>abstract="マップのビジュアライゼーションの基礎として使用する指標または計算指標を選択します。 データの特定のサブセットにフォーカスする場合は、セグメントを追加することもできます。<p>この情報は、ビジュアライゼーションのレンダリング後、いつでも更新できます。</p>"
