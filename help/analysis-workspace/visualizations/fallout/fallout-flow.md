...
>title="フォールアウト"
>abstract="ユーザーが目的のチェックポイントにどのように到達したかを表示して確認できるビジュアライゼーションを作成します。"
...
* ファネルステップ（タッチポイント）をドラッグ＆ドロップし、並べ替えます。
* 様々なディメンションと指標の値を組み合わせて使用できます。
...
フォールアウト可視化は、次の場合に最適です。

* 事前定義済みの一連のページおよび単一のエントリポイントとパスを持つジャーニーが関与するフォールアウト分析 （複数のエントリポイントとパスを持つジャーニーには、ジャーニーキャンバスを使用します）
