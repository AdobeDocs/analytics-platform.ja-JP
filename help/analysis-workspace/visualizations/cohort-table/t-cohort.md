...
1. [ フィルタービルダー ](/help/components/filters/filter-builder.md) で、セグメントをさらに編集して、「**[!UICONTROL 保存]** をクリックします。

   保存したセグメントは、[!UICONTROL Analysis Workspace[!UICONTROL  の ] フィルター ] パネルで使用できます。
