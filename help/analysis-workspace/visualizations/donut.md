...
![GraphDonut](/help/assets/icons/GraphDonut.svg) **[!UICONTROL ドーナツ]**&#x200B;ビジュアライゼーションは、円グラフと同様に、データを全体の一部またはセグメントとして表示します。 合計に対する割合を比較する場合、特に項目数が少ないときには、ドーナツビジュアライゼーションが適しています。
