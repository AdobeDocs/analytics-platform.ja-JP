...
* フロー内の任意の使用可能なステップの上にドラッグして、そのディメンションを置き換えます。
...
以下のフロービジュアライゼーションは、**[!UICONTROL イベントタイプ]**&#x200B;ディメンションを追加した結果を示しています。 このビジュアライゼーションでは、モバイルアプリのユーザーが、商品を買い物かごに追加する前に、どのように様々な画面を移動し、アプリケーションをクローズし、オファーを提示されるかなどについてのインサイトが得られます。

![ページディメンションの結果がリストの上部に表示されているフロー。](assets/flowapp-result.png)

## キャンペーンがどのように web 訪問を促しているか

どのキャンペーンが web サイトへの訪問を推進しているのかを分析したいとします。 **[!UICONTROL キャンペーン名]**&#x200B;をディメンションとするフロービジュアライゼーションを作成します
...
いずれかのフローにポインタを合わせると、詳細を表示できます。 例えば、どのキャンペーンが買い物かごのチェックアウトにつながったかを確認できます。
