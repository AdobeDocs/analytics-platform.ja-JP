...
* 使用される系列は、コンテナに基づいて異なります。**[!UICONTROL ユーザー]**&#x200B;コンテナを使用している場合、一連のイベントは、セッションになります。**[!UICONTROL セッション]**&#x200B;コンテナを使用している場合、一連のイベントは、指定した日付範囲における特定のユーザーのすべてのイベントになります。
