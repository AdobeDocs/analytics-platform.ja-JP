...
[!UICONTROL  列設定 ] にアクセスするには、フリーフォームテーブルをプロジェクトにドラッグしてから、列見出しの設定アイコン ![ 列設定 ](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Settings_18_N.svg) をクリックします。

<img src="./assets/column-settings.png" alt="合計セル、テーブルのセル、テーブルのセルのプレビューを示す列設定。" width="50%" />
...
<img src="./assets/conditional-formatting.png" alt="カスタムが選択された条件付き書式オプション" width="50%" />
...
1. フリーフォームテーブル列の指標で、設定（歯車）アイコンをクリックします。
