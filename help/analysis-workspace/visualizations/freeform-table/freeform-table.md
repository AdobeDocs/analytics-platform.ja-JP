...
*この記事では、**Customer Journey Analyticsのフリーフォームテーブル ビジュアライゼーションについて説明します**。 この記事の [2}Adobe Analytics](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table) バージョンについては、{ フリーフォームテーブル&#x200B;**を参照してください。***
