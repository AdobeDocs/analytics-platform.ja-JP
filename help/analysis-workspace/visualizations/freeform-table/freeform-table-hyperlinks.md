...
* [ ダウンロードしたPDFファイル ](/help/analysis-workspace/export/download-send.md) でハイパーリンクが機能しない。
...
1. [ プロジェクトを保存 ](/help/analysis-workspace/build-workspace-project/save-projects.md) して、変更を保存します。
