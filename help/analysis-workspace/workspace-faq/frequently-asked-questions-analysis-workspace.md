...
| 要件 | 説明 |
|--- |--- |
| 製品            SKU | 組織は、Customer Journey Analytics アドオンを使用して、Adobe Analytics（Select、Prime または Ultimate）とアクティブな契約を結んでいる必要があります。契約の種類が不明な場合や、Customer Journey Analyticsのアドオンがあるかどうかが不明な場合は、Adobeのアカウントチームにお問い合わせください。 さらに、組織を Adobe Experience Platform 用にプロビジョニングする必要があります。 |
