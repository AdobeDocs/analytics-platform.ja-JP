---
description: Analysis Workspace でテンプレートを作成および管理する方法について説明します。
title: テンプレートの作成と管理
...
1. Analysis Workspace で、「[!UICONTROL **Workspace**]」タブを選択し、左側のパネルの&#x200B;**[!UICONTROL テンプレート]**&#x200B;の下で、**[!UICONTROL _login _company_name_ テンプレート]**を選択します。
