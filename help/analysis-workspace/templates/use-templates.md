...
>title="Customer Journey Analytics製品が組織内でどのように使用されているかを確認します。"
>abstract="**これにより** Customer Journey Analyticsを使用しているユーザーの数、使用頻度および時間の経過に伴う使用状況のトレンドをより深く理解できます。 また、作成されるプロジェクトの数や、それらのプロジェクトの詳細（最も一般的に使用されるコンポーネント、ビジュアライゼーション、パネルなど）など、他の多くの使用状況統計も確認できます。<br/>**学習内容に応じて、未使用のプロジェクトやコンポーネントを削除したり** よく使用する機能のユーザートレーニングを提供するなど、様々な操作を実行できます。"
...
| **製品使用状況の概要** （近日公開） | Customer Journey Analytics製品が組織内でどのように使用されているかを確認します。 <p>**これにより** Customer Journey Analyticsを使用しているユーザーの数、使用頻度および時間の経過に伴う使用状況のトレンドをより深く理解できます。 また、作成されるプロジェクトの数や、それらのプロジェクトの詳細（最も一般的に使用されるコンポーネント、ビジュアライゼーション、パネルなど）など、他の多くの使用状況統計も確認できます。</p><p>**学習内容に応じて、未使用のプロジェクトやコンポーネントを削除したり** よく使用する機能のユーザートレーニングを提供するなど、様々な操作を実行できます。</p> |
