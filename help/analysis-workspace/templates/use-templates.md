...
| テンプレート名 | このテンプレートを使用する理由 <!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- |
| [!UICONTROL **Brand Conciergeの概要**] | 会話のパターン、ユーザーのフィードバック、お勧めの効果などを通じて、ユーザーのエンゲージメントを分析します。 <p>**これは、エンゲージメントパターンの特定** 会話の品質の評価、顧客満足度のトレンドの追跡、リンクのレコメンデーションの有効性の測定に役立ちます。</p><p>**学習内容に基づいて、AI エージェントの応答を調整する** 頻繁な問題に対するターゲットコンテンツを開発する、レコメンデーションアルゴリズムを改善する、様々なユーザーセグメントに特化した経路を作成する、など、様々な操作を実行できます。</p> |
...
| テンプレート名 | このテンプレートを使用する理由 <!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- |
| [!UICONTROL **Mix Modeler増分モデルインサイト**] | Mix Modelerで生成された選択したモデルからのインサイトを表示します。<p>**これにより** Mix Modelerで生成されたモデルからの増分インサイトをより深く理解できます。 <p>**これらのインサイトに基づいて** 次のことができるようになります。<ul><li>組織のマーケティングアクティビティの影響を視覚化し、定量化します。</li><li>パフォーマンスの高いチャネルを特定します。</li><li>最適化が必要なチャネルを特定します。</li></ul></p> |

<!-- CJA only -->

>[!CONTEXTUALHELP]
>id="template--mixmodeler-incremental-models-insights"
>title="Mix Modelerで生成された選択したモデルからのインサイトを表示します。"
