...
>title="イベント、人物、機会をまたいでアカウントがどの程度有効であるかを確認します。"
...
>title="各アカウント内の購入グループアクティビティを視覚化して、アカウントと購入グループマーケティングアプローチを通知します。"
>abstract="**これにより** どの購入グループと、それらの購入グループ内のどのユーザーが最も関与しているかを視覚化し、グループ参加のギャップを強調できます。<br/>**学んだことに基づいて、例えば** 関係がないようなグループを買う人とさらに関わり合おうとするなど、様々なことを行えるかもしれません。"

次のテンプレートを表示できます。

| テンプレート名 | このテンプレートを使用する理由 <!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **B2B アカウントエンゲージメントの概要**] | イベント、人物、機会をまたいでアカウントがどの程度有効であるかを確認します。<p>**これにより** アカウントレベルでのエンゲージメントのトレンドが上昇しているか下降しているかをより深く理解し、アカウント間でアクティビティを比較して、リテンションや獲得の取り組みをどこに集中させるかを決定できます。</p><p>**学習した内容に基づいて、関心は低いもののアカウントの重要性が原因で** より多くの注意を必要とするアカウントに焦点を合わせるなど、様々な操作を実行できます。</p> |
| [!UICONTROL **B2B オポチュニティエンゲージメントの概要**] | 商談レベルでエンゲージメントを追跡し、契約の成立や失敗を追跡します。<p>**これは、契約の進捗をより正確に予測し** エンゲージメントが急増したり停滞したりするイネーブルメントに焦点を当てるのに役立ちます。</p><p>**学習内容に基づいて、クローズ間近の案件に追加的な取り組みを行ったり** 他の案件が勢いを失っている理由を調査するなど、様々な作業を行うことができます。</p> |
| [!UICONTROL **B2B 購入グループアクティビティ**] | 各アカウント内の購入グループアクティビティを視覚化して、アカウントと購入グループマーケティングアプローチを通知します。<p>**これにより** どの購入グループと、それらの購入グループ内のどのユーザーが最も関与しているかを視覚化し、グループ参加のギャップを強調できます。</p><p>**学んだことに基づいて、例えば** 関係がないようなグループを買う人とさらに関わり合おうとするなど、様々なことを行えるかもしれません。</p> |
